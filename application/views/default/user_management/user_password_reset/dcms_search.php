        ...
        <form action="<?php echo $CI->get_encoded_url('user_management/user_password_reset/index/list'); ?>" class="signup" method="post" accept-charset="utf-8" enctype="multipart/form-data" id="frm_user_approval">
            <div class="row widget">
                <div class="widget-header">
                    <div class="title">
                        <?php echo $this->lang->line('USER_SEARCH');?>
                    </div>
                ...
                <!--                    <div class="col-xs-4">-->
                <!--                        <label class="control-label pull-right">--><?php //echo $CI->lang->line('TYPE'); ?><!--</label>-->
                <!--                    </div>-->
                <!--                    <div class="col-sm-4 col-xs-8">-->
                ...
                <div class="row show-grid ">
                    <div class="col-xs-4">
                        <label class="control-label pull-right"><?php echo $CI->lang->line('USER_ID'); ?></label>
                    </div>
                    <div class="col-sm-4 col-xs-8">
