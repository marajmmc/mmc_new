...
//         
    ...
    ?>
        ...
        <table width="75%" border="0" class="form-table" id="customFields">

  <tr>
    <td><select class="selectbox-1" name="education_level" id="education_level">
    ...
    <td> <select name="classesid" id="classes" class="selectbox-1 zilla validate[required]">
         ...
         <td><input type="text" name="cladddate" class="datepicker" value="<?php echo date("Y-m-d"); ?>"/><a href="javascript:void(0);" class="addCF">Add</a></td>
  </tr>
  <tr>
    <td colspan="3"><div id="classesname"></div></td>
  </tr>
</table>
