  ...
  <div class="row-fluid">
          ...
          <div class="featured-articles-container" style="background:#fff !important;">
            ...
            <li class="link_cls"> <a class="external" href="http://www.moedu.gov.bd//" target="_blank">
             ...
             <li class="link_cls"> <a class="external" href="https://www.teachers.gov.bd/" target="_blank">
              <table width="100%">
                <tr>
                  <td width="15%"><img src="<?php echo base_url() ?>/images/link/teachers.jpg" width="36" height="36"/></td>
                  <td width="80%" align="left"><span>শিক্ষক বাতায়ন</span></td>
                </tr>
              </table>
              </a> </li>

            <li class="link_cls"> <a class="external" href="http://www.infokosh.gov.bd/" target="_blank">
              <table width="100%">
                <tr>
                  <td width="15%"><img src="<?php echo base_url() ?>/images/link/if-logo.png" width="36" height="36"/></td>
                  <td width="80%" align="left"><span>জাতীয় ই-তথ্য কোষ</span></td>
                </tr>
              </table>
              </a> </li>
    ...
    <div class="col-lg-4" style="padding-left:0 !important;">
      <div class="viewport">
        <div class="overview" >
          <div class="featured-articles-container" style="background:#fff !important;">
            <h5 class="heading-blue">সাম্প্রতিক খবর</h5>
            <li class="link_cls2">
              <table width="100%">
                <tr>
                  <td width="15%" class="red_col">২৯ সেপ্টঃ<br/>২০১৫</td>
                  <td width="80%" align="left">প্রধানমন্ত্রী শেখ হাসিনা আন্তর্জাতিক টেলিযোগাযোগ ইউনিয়নের (আইটিইউ) কাছ থেকে ‘ আইসিটি ...</td>
                </tr>
              </table>
              </li>
            <li class="link_cls2">
              <table width="100%">
                <tr>
                  <td width="15%" class="red_col">২৯ সেপ্টঃ<br/>২০১৫</td>
                  <td width="80%" align="left"><span>প্রধানমন্ত্রী শেখ হাসিনা জাতিসংঘ পরিবেশ কর্মসূচির (ইউনেপ)‘চ্যাম্পিয়ন অব দ্যা আর্থ’ পুরস্কার  গ্রহন ...</span></td>
                </tr>
              </table>
             </li>
            <li class="link_cls2">
              <table width="100%">
                <tr>
                  <td width="15%" class="red_col">৩০শে অগাষ্ট<br/>২০১৫</td>
                  <td width="80%" align="left"><span>বাংলাদেশ পাবলিক সার্ভিস কমিশনের ওয়েব সাইটে ৩৪ তম বিসিএস পরীক্ষার চুড়ান্ত ফলাফল প্রকাশ করা হয়েছে</span></td>
                </tr>
              </table>
             </li>
          </div>
    ...
    <div class="col-lg-4" style="padding-left:0 !important;">
      <div class="viewport">
        <div class="overview" >
          <div class="featured-articles-container" style="background:#fff !important;">
            <h5 class="heading-blue">সামাজিক যোগাযোগ মাধ্যম</h5>
            <li class="link_cls2">
              <table width="100%">
                <tr>
                  <td width="15%" class="red_col">২৯ সেপ্টঃ<br/>২০১৫</td>
